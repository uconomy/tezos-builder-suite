# Contributing
We'd definitely love to have your contributions to this package. We'll be more than happy to review and discuss every PR to this repository.
...
Before downloading the repo, you'll need both [Rush](https://rushjs.io/pages/developer/new_developer/) monorepo tools and [pnpm](https://pnpm.io/installation) package manager.
...
Then you'll need two separate Terminals so, that you can rely on file-watch and error reporting from both the frontend (browser client) and the backend (local server) apps. Both frontend and backend need to be started to be able to run and develop this tool.
...
Please make use of comments where you think someone after you might find hard to get the whole picture of your code.
...
- you can capitalize first letter (optional)
- no dot (.) at the end
